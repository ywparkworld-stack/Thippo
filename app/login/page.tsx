    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-6 font-[family-name:var(--font-geist-sans)]">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mt-6 mb-1">おかえりなさい</h1>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-8 shadow-sm space-y-5">
          ...
          <Link
            href="/select-role"
            className="block w-full bg-indigo-600 text-white text-center py-4 rounded-xl font-semibold hover:bg-indigo-700 transition-colors mt-2"
          >
            ログイン
          </Link>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          アカウントをお持ちでない方は
          <Link href="/register" className="text-indigo-600 font-semibold hover:underline ml-1">新規登録</Link>
        </p>
      </div>
    </div>
  );
